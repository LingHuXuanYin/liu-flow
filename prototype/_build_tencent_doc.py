"""
写 docs/腾讯云后端服务开通流程.md
- 用 Python 直接 open(...).write() 绕过 write 工具的全角标点污染
- 对应 V0.2.0 PRD 的"零代码后端"实现路径：CloudBase Auth + CloudBase PostgreSQL + RLS
- 不写任何云函数
"""

import os

PATH = r"Q:\large_program\liu-flow\docs\腾讯云后端服务开通流程.md"


CONTENT = """# 腾讯云后端服务开通流程（V0.2.0 流 Flow）
...
def main():
    with open(PATH, "w", encoding="utf-8") as f:
        f.write(CONTENT)
    print(f"[ok] {PATH}")
    print(f"     {len(CONTENT):,} chars, {len(CONTENT) / 1024:.1f} KB")
